    ...
    public void send(NotificationEmail email, JavaMailSender sender) throws NotificationFailedException {
        MimeMessagePreparator messagePreparator = msg -> {
            ...
            messageHelper.setText(
                String.format(Constant.NOTIFICATION, email.getDoctorName(), dateFormatter(email.getMeetDate()))
            );
        };
        ...
        try {
            ...
            throw new NotificationFailedException("Failed to send verification email");
        }
    }
